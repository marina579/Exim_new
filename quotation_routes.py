...
def generate_quotation_document(data):
    ...
    # Get validity date directly from form (calendar input) or calculate from days
...
<body>
    <div class="header">
        <div class="header-left">
            <img src="{logo_base64}" alt="Marineco Logo" style="width: 140px; height: auto; display: block; shape-rendering: crispEdges;">
        </div>
